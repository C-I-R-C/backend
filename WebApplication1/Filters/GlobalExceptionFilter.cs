...
namespace WebApplication1.Filters
{
    public class GlobalExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            // В разработке можно добавить больше деталей
        ...
        private (HttpStatusCode statusCode, string errorType, string message) MapException(Exception exception)
        {
            return exception switch
            {
                ...
                ArgumentException => (HttpStatusCode.BadRequest, "VALIDATION_ERROR", "Invalid request parameters"),
                InvalidOperationException => (HttpStatusCode.BadRequest, "BUSINESS_RULE_ERROR", exception.Message),
                DbUpdateConcurrencyException => (HttpStatusCode.Conflict, "CONCURRENCY_ERROR", "The resource was modified by another request"),
                DbUpdateException => (HttpStatusCode.BadRequest, "DATABASE_ERROR", "Error saving data"),
                NotImplementedException => (HttpStatusCode.NotImplemented, "NOT_IMPLEMENTED", "Feature not implemented"),
