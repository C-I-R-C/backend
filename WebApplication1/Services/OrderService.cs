...
namespace WebApplication1.Services
{
    ...
    public class OrderService
    {
...

        {
            ...
            var client = _context.Clients.FirstOrDefault(c => c.Id == orderDto.ClientId) ?? throw new ArgumentException();
...

        {
            ...
            var order = await _context.Orders.FindAsync(id) ?? throw new DivideByZeroException();
        ...
        public async Task<PagedResponse<OrderResponseDto>> 
            QueryOrders(
                DateTime? orderDate,
        ...
        public async Task<List<UrgentOrderDto>> 
            GetMostUrgentOrders(
                int count = 5 )
        ...
        public async Task<OrderProfitDto> 
        ...
        private async Task<OrderValidationResult> 
            ValidateAllMaterialsAsync(
        ...
        private async Task<(List<MaterialStatus> statuses, bool allAvailable)> 
            ValidateMaterialsAsync<T>(
