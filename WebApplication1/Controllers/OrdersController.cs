...
namespace WebApplication1.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PagedResult<OrderResponseDto>>> 
            GetOrders(
        ...
        [HttpGet("query")]
        public async Task<ActionResult<PagedResponse<OrderResponseDto>>> 
            QueryOrders(
...

        {
            ...
            DateTime? OrderDate = 
                DateTime.TryParse(query.OrderDateString, out var date)? 
                DateTime.SpecifyKind(date.Date, DateTimeKind.Utc) : null;

            DateTime? CompletionDate = 
                DateTime.TryParse(query.CompletionDateString, out var date1) ? 
                DateTime.SpecifyKind(date1.Date, DateTimeKind.Utc): null;
        ...
        [HttpGet("urgent")]
        public async Task<ActionResult<List<UrgentOrderDto>>> 
            GetUrgentOrders(
        ...
        [HttpGet("{id}/profit")]
        public async Task<ActionResult<OrderProfitDto>> 
            GetOrderProfit(
                int id )
        ...
        public async Task<ActionResult<OrderValidationResult>>
