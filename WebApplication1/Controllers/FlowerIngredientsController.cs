...
namespace WebApplication1.Controllers
{
    ...
    public class FlowerIngredientsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PagedResult<FlowerIngredientDto>>> 
            GetIngredientsForFlower(
                int flowerId, 
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<FlowerIngredient>> 
            GetFlowerIngredient(
                int id )
        ...
        [HttpPost]
        public async Task<ActionResult<FlowerIngredientDto>> 
            AddIngredientToFlower(
                int flowerId, 
                [FromBody] AddIngredientToFlowerDto dto )
