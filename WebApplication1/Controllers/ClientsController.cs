...
namespace WebApplication1.Controllers
{
    ...
    public class ClientsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PagedResult<ClientResponseDto>>> 
            GetClients(
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<ClientResponseDto>> 
            GetClient(
                int id, 
                bool isWithOrders )
        ...
        [HttpGet("search")]
        public async Task<ActionResult<List<ClientWithDetailedOrdersDto>>> 
            SearchClients(
