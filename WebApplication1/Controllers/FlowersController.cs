...
namespace WebApplication1.Controllers
{
    ...
    public class FlowersController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task <ActionResult<PagedResult<FlowerDto>>> 
            GetAll(
        ...
        [HttpGet("{id}")]
        public async  Task <ActionResult<FlowerWithIngredientsDto>> 
            GetById(
                int id )
        ...
        [HttpPost]
        public async Task <ActionResult<FlowerDto>> 
            Create(
        ...
        public async Task<ActionResult<FlowerDto>> 
            UpdateQuantity(
                int id, 
                [FromBody] FlowerQuantityUpdateDto updateDto )
        {
